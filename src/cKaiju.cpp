...
PYBIND11_MODULE(cKaiju, m) {
    ...
    py::class_<Robot, std::shared_ptr<Robot>>(m, "Robot", R"pbdoc(
        ...
        .def_readwrite("averagedAlphaPath", &Robot::averagedAlphaPath)
        .def_readwrite("averagedBetaPath", &Robot::averagedBetaPath)
    ...
    py::class_<RobotGrid, std::shared_ptr<RobotGrid>>(m, "RobotGrid", R"pbdoc(
        ...
        .def("smoothVelocities", &RobotGrid::smoothVelocities)
