...
class Robot(object):
    ...
    @property
    def neighborIntersections(self):
        intersections = []
        for n in self.sketchyNeighbors:
            if n.isCollided:
                intersections.append([n.bottomIntersect, n.topIntersect])
                ...
                for colN, (tIntersect, bIntersect) in zip(self.collidedNeighbors, self.neighborIntersections):
                    ...
                    if armwrap:
                        if bool(tIntersect):
                            ...
                            colCent = numpy.array(bIntersect.centroid)
                        colCent = colCent - colN.xyAlphaFocal
                        fib = colN.xyFiberFocal - colN.xyAlphaFocal
