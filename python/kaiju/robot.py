...
def inspectFails(runNum):
    ...
    fileName = "/Users/csayres/Desktop/collisions/collisionCache/seed%i/step500.txt"%runNum
    robotPositions = numpy.loadtxt(fileName)
    rg = motionPlan()
    rg.setPosFromCache(robotPositions)
    xlim = [-300,300]
    ylim = [-300,300]
    rg.xlim = xlim
    rg.ylim = ylim
